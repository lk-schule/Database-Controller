...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Mrz 2017 um 11:32
...
--
-- Datenbank: `kreativlabor`
--
CREATE DATABASE IF NOT EXISTS `kreativlabor` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `kreativlabor`;
...
--
-- Tabellenstruktur für Tabelle `kunde_privat`
--

CREATE TABLE IF NOT EXISTS `kunde_privat` (
  `KundenID` int(11) NOT NULL DEFAULT '0',
...
--
-- Tabellenstruktur für Tabelle `tab_bezirk`
--

CREATE TABLE IF NOT EXISTS `tab_bezirk` (
...
--
-- Daten für Tabelle `tab_bezirk`
--

INSERT INTO `tab_bezirk` (`BezirkNr`, `Bezirk`) VALUES
(1, 'Nord'),
(2, 'Ost'),
(3, 'West'),
(5, 'Mitte'),
...
('94563', 'Otzing'),
('94565', 'Bertholling'),
('94566', 'Reichenberg b Riedlhütte'),
('94568', 'Auwies'),
...
--
-- Tabellenstruktur für Tabelle `tab_person`
--

CREATE TABLE IF NOT EXISTS `tab_person` (
  `PersonNr` varchar(50) CHARACTER SET utf16 COLLATE utf16_german2_ci NOT NULL,
  `Vorname` varchar(50) DEFAULT NULL,
  `Nachname` varchar(50) DEFAULT NULL,
  `Adresse` varchar(50) CHARACTER SET utf16 COLLATE utf16_german2_ci DEFAULT NULL,
  `plz` char(5) DEFAULT NULL,
  PRIMARY KEY (`PersonNr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `tab_person`
--

INSERT INTO `tab_person` (`PersonNr`, `Vorname`, `Nachname`, `Adresse`, `plz`) VALUES
('1', 'Adalbert', 'Groterauh', 'Badstrasse 7', '48167'),
('10', 'Melanie', 'Bender', 'Münchner Strasse 54', '48268'),
('11', 'Tadäus', 'Chrichter', 'Wiener Strasse 1', '48308'),
('12', 'Gerlinde', 'Eschersmann', 'Berliner Strasse 28', '48366'),
('13', 'Berd', 'von Bückling', '', ''),
('14', 'Elfiede', 'Farrhaupt', 'Museumstrasse 384', '48480'),
('2', 'Klaus', 'Germer', '', ''),
('3', 'Lara', 'Zacher', 'Eilenstrasse 2', '48356'),
('4', 'Sabine', 'Schaffer', 'Turmstrasse 55', '48720'),
('5', 'Armin', 'Hauser', 'Poststrasse 33', '48703'),
('6', 'Hugo', 'Grabowsky', 'Opernplatz 12', '48157'),
('7', 'Monika', 'Dattelhof', '', ''),
('8', 'Heribert', 'Horstkamp', 'Hafenstrasse 13', '48336'),
('9', 'Markus', 'Möller', 'Neue Strasse 44', '48231');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `tab_projekt`
--

CREATE TABLE IF NOT EXISTS `tab_projekt` (
  `projektNr` char(2) NOT NULL,
...
--
-- Daten für Tabelle `tab_projekt`
--

INSERT INTO `tab_projekt` (`projektNr`, `Titel`, `Etat`) VALUES
('1', 'Neugestaltung des Hamann-Platz', '4500'),
('2', 'Nahverkehrsanbindung', '4500'),
('3', 'Umweltverträglichkeit, Verkehr', '5600'),
('4', 'Sozialverträgliches Wohnen', '3400'),
('5', 'Umweltverträglichkeit, Altlast', '6200'),
('6', 'Naherholung', '4500'),
('7', 'Strukturanalyse, Versorgung', '2500');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `tab_stadtteil`
--

CREATE TABLE IF NOT EXISTS `tab_stadtteil` (
  `StadtteilNr` char(2) NOT NULL,
  `Stadtteil` varchar(30) DEFAULT NULL,
  `BezirkNr` char(2) DEFAULT NULL,
  PRIMARY KEY (`StadtteilNr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `tab_stadtteil`
--

INSERT INTO `tab_stadtteil` (`StadtteilNr`, `Stadtteil`, `BezirkNr`) VALUES
('1', 'Coerde', '48'),
('10', 'Albachten', '48'),
('11', 'Sprakel', '48'),
('12', 'Handorf', '48'),
...
--
-- Tabellenstruktur für Tabelle `ztab_projekt_person`
--

CREATE TABLE IF NOT EXISTS `ztab_projekt_person` (
  `ProjektNr` int(11) NOT NULL DEFAULT '0',
  `PersonNr` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ProjektNr`,`PersonNr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `ztab_projekt_person`
--

INSERT INTO `ztab_projekt_person` (`ProjektNr`, `PersonNr`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
--
-- Tabellenstruktur für Tabelle `ztab_projekt_stadtteil`
--

CREATE TABLE IF NOT EXISTS `ztab_projekt_stadtteil` (
  `ProjektNr` int(11) NOT NULL DEFAULT '0',
  `StadtteilNr` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ProjektNr`,`StadtteilNr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `ztab_projekt_stadtteil`
--

INSERT INTO `ztab_projekt_stadtteil` (`ProjektNr`, `StadtteilNr`) VALUES
(1, 1),
(2, 2),
(2, 3),
(2, 4),
